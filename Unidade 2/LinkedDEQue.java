...
public class LinkedDEQue<T> implements DEQueable<T> {
	...
	/**
	 * Retorna a quantidade de objetos presentes na fila.
	 * 
	 * 
	 * @return inteiro correspondente a quantidade de itens na fila
	 */
	@Override
	public int size(){
		return amount;
	 ...
	 * 
	 * 
	 * @return inteiro correspondente a quantidade de slots da fila
	 */
	@Override
